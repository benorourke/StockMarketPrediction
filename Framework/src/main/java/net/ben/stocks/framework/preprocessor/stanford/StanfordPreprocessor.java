package net.ben.stocks.framework.preprocessor.stanford;
...
import net.ben.stocks.framework.preprocessor.Preprocess;
import net.ben.stocks.framework.preprocessor.Preprocessor;
